...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'resto_homepage');
            }

            return array (  '_controller' => 'RestoBundle\\Controller\\DefaultController::indexAction',  '_route' => 'resto_homepage',);
        }

        // ajout_plat
        if ($pathinfo === '/ajout-plat') {
